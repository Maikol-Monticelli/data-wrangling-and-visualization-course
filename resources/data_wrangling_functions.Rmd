...
## filter
- it is for rows
- you can use filter(row %in% c(x,y,z)) to filter any item in the vector mentioned
...
## select
 - it selects column's, it helps to figure and filter out the most important data from big datasets 
 - it is for column's
...
## distinct
 - shows the distinct answers that the participants gave
